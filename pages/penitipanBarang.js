...
const penitipanBarang = ({ navigation }) => {
    ...
    const [noSeriBarang,    setNoSeriBarang]    = useState();
        ...
        return (
            <ScrollView style={styles.penitianRumah} showsVerticalScrollIndicator={false} showsHorizontalScrollIndicator={false}> 
                ...
                <View style={styles.contentTitip}>
                    <Title style={styles.textTitleTitip}> Penitipan Barang </Title>
                    ...
                    <View style={styles.contentForm}>
                        <View style={styles.contentForm}>
                            <Text style={styles.titleForm}> Data Pemilik </Text>
                            ...
                            <Text style={styles.titleForm}> Data Barang </Text>
                            ...
                            <TextInput style={styles.textInput} 
                                ...
                                value={namaBarang} />
                            <TextInput style={styles.textInput} 
                                onChangeText={(merekBarang) =>  setMerekBarang(merekBarang)} 
                                placeholder="Merek Barang" 
                                value={merekBarang} />
                            <TextInput style={styles.textInput} 
                                onChangeText={(warnaBarang) =>  setWarnaBarang(warnaBarang)} 
                                placeholder="Warna Barang" 
                                value={warnaBarang} />
                            <TextInput style={styles.textInput} 
                                onChangeText={(jenisBarang) =>  setJenisBarang(jenisBarang)} 
                                placeholder="Jenis Barang" 
                                value={jenisBarang} />
                            <TextInput style={styles.textInput} 
                                onChangeText={(noSeriBarang) =>  setNoSeriBarang(noSeriBarang)} 
                                placeholder="No Seri Barang" 
                                value={noSeriBarang} />
