...
class CreateTblPenitipanPerhiasan extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_penitipan_perhiasan', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tbl_penitipan_perhiasan');
    }
}
